...
if (ispc())
  %% Windows
  edfapiIncludesFolder= 'C:\Program Files (x86)\SR Research\Eyelink\EDF_Access_API\Example';
  edfapiLibraryFolder= 'c:\Program Files (x86)\SR Research\EyeLink\EDF_Access_API\lib\win64\';
